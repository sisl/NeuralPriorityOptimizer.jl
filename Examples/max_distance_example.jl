...
params = PriorityOptimizerParameters(max_steps=40000, verbosity=1)
time = @elapsed x_star, lower_bound, upper_bound, steps = max_network_difference(network_1, network_2, input_set, params)
